...
import { ArrowLeft, Loader2, CheckCircle2, AlertCircle, Truck } from "lucide-react"
...
export default function DeliveryOTP() {
  ...
  const handleVerify = async (otpValue = null) => {
    ...
    try {
      ...
      // Redirect to delivery home after short delay
      setTimeout(() => {
        navigate("/delivery")
      }, 1000)
    } catch (err) {
          ...
          <Card className="w-full max-w-lg shadow-lg relative">
            <CardHeader className="text-center space-y-2 relative">
              <Button
                ...
                onClick={() => navigate(authData.isSignUp ? "/delivery/signup" : "/delivery/login")}
              >
