...
export default function AllOrdersPage() {
  ...
  // Default to "all" filter to show all orders
  ...
  const getStatusBadgeColor = (status) => {
    ...
    } else if (normalized === ORDER_STATUS.PENDING) {
      return "bg-gray-100 text-gray-700"
    } else if (normalized === ORDER_STATUS.CONFIRMED) {
      return "bg-blue-100 text-blue-700"
    } else if (normalized === ORDER_STATUS.COOKING) {
      return "bg-orange-100 text-orange-700"
    } else if (normalized === ORDER_STATUS.READY_TO_HANDOVER) {
      return "bg-green-100 text-green-700"
    } else {
      return "bg-gray-100 text-gray-700"
    }
