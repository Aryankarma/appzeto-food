...
import { UserCog, ChevronDown, ArrowUpDown, Trash2 } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <h2 className="text-xl font-bold text-slate-900">Employee Role Table {filteredRoles.length}</h2>
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="px-4 py-2.5 text-sm font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 flex items-center gap-2 transition-all">
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-20 text-center">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-sm text-slate-500">No roles match your search</p>
                      </div>
                    </td>
                  </tr>
                ) : (
