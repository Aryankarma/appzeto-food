...
import { Search, Download, Filter, Columns, Eye, Printer, X, FileSpreadsheet, FileDown } from "lucide-react"
...
export default function SearchingDeliveryMan() {
  const totalUnassigned = MOCK_ORDERS.length
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center rounded-full bg-blue-50 px-3 py-1 text-xs font-medium text-blue-600 border border-blue-100">
            Unassigned Orders: {totalUnassigned}
          </span>
        </div>
      </div>
                  ...
                  <tr key={order.id} className="hover:bg-gray-50">
                    ...
                    {columns.total && (
                      <td className="px-3 py-3 whitespace-nowrap text-sm">
                        ...
                        <div className="text-xs text-red-500 font-semibold mt-0.5">{order.paymentStatus}</div>
                      </td>
                    )}
                    {columns.status && (
                      <td className="px-3 py-3 whitespace-nowrap text-sm">
