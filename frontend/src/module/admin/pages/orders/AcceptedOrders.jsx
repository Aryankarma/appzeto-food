...
function AcceptedHeader() {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
      <div>
        <h1 className="text-lg font-semibold text-slate-800">Accepted Orders</h1>
        <p className="text-xs text-slate-500">
          Orders that have been accepted by restaurants and are waiting for processing.
        </p>
      </div>
