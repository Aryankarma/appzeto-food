...
function ScheduledHeader() {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
      <div>
        <h1 className="text-lg font-semibold text-slate-800">Scheduled Orders</h1>
        <p className="text-xs text-slate-500">
          View orders that are scheduled for future delivery or pending confirmation.
        </p>
      </div>
