...
function FoodOnTheWayHeader() {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
      <div>
        <h1 className="text-lg font-semibold text-slate-800">Food On The Way Orders</h1>
        <p className="text-xs text-slate-500">
          Orders where food has left the restaurant and is on the way to customers.
        </p>
      </div>
...
function FoodOnTheWaySearchBar() {
  return (
    <div className="mb-4">
